...
export const ChatPanel: React.FC = () => {
  ...
  return (
    <div className="tw-flex tw-flex-col lg:tw-flex-row tw-gap-6 tw-min-h-[70vh]">
      <ChatThreadList
        threads={threads}
      ...
      <div className="tw-flex-1 tw-min-h-[400px] tw-bg-[var(--surface-card)] tw-rounded-xl tw-shadow-[var(--shadow-sm)] tw-border tw-border-[var(--border-color)] tw-flex tw-flex-col">
        {error ? (
        ...
        {!activeThread ? (
          <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-flex-1 tw-text-center tw-gap-4 tw-p-6">
            <div>
              <p className="tw-text-base tw-font-semibold tw-text-[var(--text-primary)]">
                {hasVisibleThreads ? 'Pick a conversation to get started' : 'No chats in this view yet'}
              </p>
              <p className="tw-mt-1 tw-text-sm tw-text-[var(--text-secondary)]">
                {hasVisibleThreads
            ...
            <button
              ...
              className="tw-inline-flex tw-items-center tw-justify-center tw-rounded-lg tw-bg-primary tw-text-white tw-px-5 tw-py-2.5 tw-text-sm tw-font-medium hover:tw-bg-primary/90 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-primary/50"
            >
