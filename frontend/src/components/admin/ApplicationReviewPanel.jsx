                  ...
                  <td className="tw-px-6 tw-py-4 tw-whitespace-nowrap">
                    <div className="tw-flex tw-flex-wrap tw-gap-3 tw-text-sm tw-font-medium">
                      <button
                        ...
                        className="tw-inline-flex tw-items-center tw-justify-center tw-rounded-md tw-p-1.5 tw-bg-purple-50 tw-text-purple-700 hover:tw-bg-purple-100 tw-transition-colors"
                        title="View Details"
                      >
                      ...
                      <button
                        ...
                        title="Change Role"
                      >
                        <svg className="tw-w-4 tw-h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
