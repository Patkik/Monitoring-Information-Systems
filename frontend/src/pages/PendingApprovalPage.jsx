        ...
        <div className="tw-max-w-2xl tw-mx-auto tw-px-4">
          ...
          <div className="tw-bg-white tw-rounded-xl tw-shadow-lg tw-p-8 tw-text-center">
            ...
            <p className="tw-text-lg tw-text-gray-600 tw-mb-6">
              {isRejected
                ? 'Please review the summary below and update your information so we can reassess your mentee application.'
                : 'Thank you for submitting your mentee application. Our team is reviewing your details and will notify you once a decision has been made.'}
            </p>
            ...
            {applicationData && (
              <div className="tw-bg-gray-50 tw-rounded-lg tw-p-6 tw-mb-6 tw-text-left">
                ...
                <div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4 tw-text-sm">
                  {profile && (
                    <>
                      <div>
                        ...
                        <span className="tw-ml-2 tw-font-medium">{profile.firstname} {profile.lastname}</span>
                      </div>
                      <div>
                  ...
                  {applicationData.programmingLanguage && (
                    <div>
                  ...
                  {applicationData.specificSkills && (
                    <div>
                      <span className="tw-text-gray-600">Specific Skills:</span>
                      <span className="tw-ml-2 tw-font-medium">{applicationData.specificSkills}</span>
                    </div>
                  )}
                  {applicationData.motivation && (
                    <div className="tw-col-span-1 md:tw-col-span-2">
                      <span className="tw-text-gray-600">Motivation:</span>
                      <span className="tw-ml-2 tw-font-medium">{applicationData.motivation}</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div
              className={`${isRejected ? 'tw-bg-red-50 tw-border-red-200' : 'tw-bg-blue-50 tw-border-blue-200'} tw-border tw-rounded-lg tw-p-4 tw-mb-6`}
            >
              <div className="tw-flex tw-items-start">
                ...
                <div>
                  ...
                  <p className={`tw-text-sm ${isRejected ? 'tw-text-red-700' : 'tw-text-blue-700'}`}>
                    {isRejected
                      ? 'Please reach out to the admin team for feedback and submit an updated application to continue.'
